...
const timeSlotArr = ['9:00AM - 10:00AM', '10:00 AM - 11:00 AM', '11:00 AM - 12:00 PM', '12:00 PM - 1:00 PM', '01:00 AM - 02:00 PM', '02:00 AM - 03:00 PM', '03:00 AM - 04:00 PM', '04:00 AM - 05:00 PM', '05:00 AM - 06:00 PM', '06:00 AM - 07:00 PM', '07:00 AM - 08:00 PM' , '08:00 AM - 09:00 PM'];
...
exports.edit = (req, res, next) => {
   ...
   // Promise.all([Booking.findById(id) , Booking.find({courtId: id, date: curDate })])
    ...
    .then(booking => {
        if (booking) {
            Booking.find({courtId: booking.courtId, date: booking.date })
            .then(list => {
                ...
                res.render('./booking/edit', {booking, bookingArr, timeSlotArr});
            })
